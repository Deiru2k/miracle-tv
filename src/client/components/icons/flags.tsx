...
const createFlag = (displayName: string, path: React.ReactElement) =>
  createIcon({
    ...defaultParams,
    displayName,
    path,
...
export const RussianFlagIcon = createFlag(
  "RussianFlagIcon",
...
export const USFlagIcon = createFlag(
  "USFlagIcon",
  <g fillRule="evenodd">
    <g strokeWidth="1pt">
      <path
...
export const PLFlagIcon = createFlag(
  "PLFlagIcon",
  <g fill-rule="evenodd">
