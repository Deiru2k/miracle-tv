...
export const ChangePassword = () => {
    ...
    const [changePasswordMutation, { loading: isChanging }] = useSettingsChangePasswordMutation({
      onCompleted: () =>
    ...
    const changePassword = useCallback((values: ChangePasswordInput) => {
            ...
            <Form<ChangePasswordInput> onSubmit={changePassword}>
                {({ handleSubmit }) => (
                    <form onSubmit={handleSubmit}>
                        <FormInput name="currentPassword" label="Current Password" mb={4} />
                        <FormInput name="newPassword" label="New Password" />
                        <Flex mt={4}>
                            <Button ml="auto" type="submit" isLoading={isChanging}>Change</Button>
                        </Flex>
                    </form>
                )}
            </Form>
