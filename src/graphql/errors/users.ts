...
export class IncorrectUserError extends ApolloError {
  constructor() {
    super("Incorrect user supplied", "E_INCORRECT_USER");

    Object.defineProperty(this, "name", { value: "IncorrectUserError" });
  }
}
